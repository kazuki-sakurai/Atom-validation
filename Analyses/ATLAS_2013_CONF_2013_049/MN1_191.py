...
if __name__ == '__main__':
    ...
    table_name = '$\\tilde \\mu^\\pm(191) \\to \\mu^\\pm \\tilde \\chi_1^0(90)$ (ATLAS\\_CONF\\_2013\\_049)'
    description = ''
    ...
    initial_list = [ 
                        ['mm: Trigger',   159.,  '$\\mu \\mu$: Trigger'],
                        ['mm: Z-veto',    148.,  '$\\mu \\mu$: $Z$ veto'],                        
                        ['mm: Jet veto',   62.,  '$\\mu \\mu$: Jet veto'],
                        ['mm: METrel',     50.,  '$\\mu \\mu$: ${\\rm MET}^{\\rm rel}$'],
                        ['mm: mT2 > 90',   21.6, '$\\mu \\mu$: $m_{T2} > 90$'],
                        ['mm: mT2 > 110',  12.0, '$\\mu \\mu$: $m_{T2} > 110$']
                        ]
