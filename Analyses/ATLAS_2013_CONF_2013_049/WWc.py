...
if __name__ == '__main__':
    ...
    table_name = '$\\tilde \\chi_1^\\pm(200) \\to W^\\pm \\tilde \\chi_1^0(0)$ (ATLAS\\_CONF\\_2013\\_049)'
    description = ''
    ...
    initial_list = [ 
                    ["WW: Jet veto",             31.,  "WW: Jet veto"],
                    ["WW: pT_l1>35, pT_l2>20",   25.,  "WW: $p_T(\\ell_1) > 35, p_T(\\ell_2) > 20$"],
                    ["WWc",                      3.3,   "WWc"]
                    ]
