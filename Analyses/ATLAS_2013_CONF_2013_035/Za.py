...
if __name__ == '__main__':
    ...
    table_name = 'SR Za: (ATLAS\\_CONF\\_2013\\_035)'
    description = '''
        \\begin{itemize}
    ...
    initial_list = [ 
                    ['Lepton multi',         1071.4,  'Lepton multiplicity'],
                    ['SFOS requirement',     1067.5,  'SFOS requirement'],
                    ['b veto',                989.4,  '$b$-jet veto'],
                    ['Z requirement',         912.7,  '$Z$ requirement'],
                    ['SRZa: MET 75-120',      170.7,  'SRZa: $75 > {\\rm MET} > 120$'],
                    ['SRZa: mT < 110',        159.3,  'SRZa: $m_T < 110$']
                    ]
