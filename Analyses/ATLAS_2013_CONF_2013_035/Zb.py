...
if __name__ == '__main__':
    ...
    table_name = 'SR Zb: (ATLAS\\_CONF\\_2013\\_035)'
    description = '''
        \\begin{itemize}
    ...
    initial_list = [ 
                    ['Lepton multi',          259.8,  'Lepton multiplicity'],
                    ['SFOS requirement',      258.0,  'SFOS requirement'],
                    ['b veto',                240.0,  '$b$-jet veto'],
                    ['Z requirement',         227.1,  '$Z$ requirement'],
                    ['SRZb: MET 75-120',       67.7,  'SRZb: $75 < {\\rm MET} < 120$'],
                    ['SRZb: mT > 110',         27.8,  'SRZb: $m_T > 110$']
                    ]
