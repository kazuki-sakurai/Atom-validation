...
if __name__ == '__main__':
    ...
    table_name = '$\\tilde \\mu^\\pm(191) \\to \\mu^\\pm \\tilde \\chi_1^0(90)$ (ATLAS\\_2014\\_I1286761 (1403.5294))'
    description = ''
    ...
    initial_list_SF = [ 
                    ['= 2 OSlep pT > 35, 20: SF',  147.8, '$=2$ OSlep $p_T > 35, 20$: SF'],
                    ['Jet Veto: SF',                64.7, 'Jet veto: SF'],
                    ['Z Veto: SF',                  60.0, '$Z$ veto: SF'],
                    ['mT2 90: SF',                  21.7, '$m_{T2} > 90$: SF'],
                    ['mT2 120: SF',                  8.5, '$m_{T2} > 20$: SF'],
                    ['mT2 150: SF',                  1.1, '$m_{T2} > 150$: SF']
                    ]
